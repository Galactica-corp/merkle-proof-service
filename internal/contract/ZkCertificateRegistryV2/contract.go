...
package ZkCertificateRegistryV2
...
func (_ZkCertificateRegistry *ZkCertificateRegistryCaller) ZkCertificateProcessingData(opts *bind.CallOpts, zkCertificateHash [32]byte) (CertificateData, error) {
	var out []interface{}
	err := _ZkCertificateRegistry.contract.Call(opts, &out, "zkCertificateProcessingData", zkCertificateHash)

	if err != nil {
		return *new(CertificateData), err
	}

	out0 := *abi.ConvertType(out[0], new(CertificateData)).(*CertificateData)
...
//
// Solidity: function zkCertificateProcessingData(bytes32 zkCertificateHash) view returns((address,uint256,uint8))
func (_ZkCertificateRegistry *ZkCertificateRegistrySession) ZkCertificateProcessingData(zkCertificateHash [32]byte) (CertificateData, error) {
...
//
// Solidity: function zkCertificateProcessingData(bytes32 zkCertificateHash) view returns((address,uint256,uint8))
func (_ZkCertificateRegistry *ZkCertificateRegistryCallerSession) ZkCertificateProcessingData(zkCertificateHash [32]byte) (CertificateData, error) {
	return _ZkCertificateRegistry.Contract.ZkCertificateProcessingData(&_ZkCertificateRegistry.CallOpts, zkCertificateHash)
}
